...
Speakers of ‘languages’ may have _linguistic_ rights to use their language. Speakers of ‘dialects’ almost never have similar rights.
...
_Socio-political factors matter_
...
_A range of factors trigger different ways of speaking._
...
OLs are established for _pragmatic_ reasons.
...
NLs are _symbolic_ and intended to represent the nation and its projected national identity.
...
Languages all over the world are becoming _moribund_.
...
- There are 8 languages with 100+ million L1 speakers.
  ...
  - If a language with 20,000 speakers or less should be characterized as _endangered_, then:
...
- Bilingual education
- Pre-school _"language nests"_

<br />

_Speakers of endangered languages don't need to abandon their heritage languages to acquire another major language._
...
- **Diglossia**: Switching between two different varieties of the same language in _different areas of life_.
...
- **Code-switching**: Switching between two (or more) different languages in _a single conversation_.

### 🎛 Levels of code-switching

1. Sentence-boundary CS
2. Extra-sentential CS (_tag-insertion_)
3. Clause-boundary CS
4. Intra-sentential CS (_code-mixing_)
