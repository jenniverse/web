...
export const about = () => {
  return (
    <>
      I am an undergraduate student at University of Southern California majoring in Computer Science. I'm currently working at Apple as an intern, and I previously worked at JPL NASA.
    </>
  );
};
export const bio = () => {
